    ...
    const loadData = async () => {
      try {
        ...
        const calculatedStats = {
          ...
          tiempoPromedioRespuesta: 4.2, // This would need to be calculated from real data
          serviciosMasUtilizados
        };
      ...
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <Card className="border-purple-200 bg-purple-50">
            ...
            <CardContent className="pt-0">
              <div className="text-2xl sm:text-3xl font-bold text-purple-800">{stats.tiempoPromedioRespuesta} min</div>
              <p className="text-xs sm:text-sm text-purple-600">Tiempo de respuesta</p>
            </CardContent>
          </Card>
        </div>
